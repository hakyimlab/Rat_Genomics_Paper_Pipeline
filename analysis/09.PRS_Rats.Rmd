...
prs_ptrs_cor <- prs_ptrs_cor %>% mutate(type_model = NA)
if

ggplot(prs_ptrs_cor, aes(model, cor))  + geom_errorbar(aes(ymin = conf.int.min, ymax = conf.int.max ), width=0.2,  color="gray48") + geom_point()
```
