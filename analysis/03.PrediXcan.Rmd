...
manhattan(bmi_manhat, chr="chr", bp="start", snp="gene_name", p="pvalue", ylim = c(0, 13), suggestiveline = T, genomewideline = T, annotatePval = 5.767678e-07, highlight = human_bmi_genes$rat_gene)
abline(h= 6.238999, col="blue")

manhattan(height_manhat, chr="chr", bp="start", snp="gene_name", p="pvalue",  suggestiveline = T, genomewideline = T, annotatePval = 5.767678e-07, highlight = human_height_genes$rat_gene)
abline(h= 6.238999, col="blue")
