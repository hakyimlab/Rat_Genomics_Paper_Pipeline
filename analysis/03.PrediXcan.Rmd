...
```{r filter pred expression for no overlap of rats, eval=FALSE}
...
#full_df <- read_tsv("/Users/natashasanthanam/Github/rat-genomic-analysis/data/rat_metabolic_traits_Ac_full_assocs.txt", col_names = TRUE) %>% filter(n_samples <= 3407)

tempo_df <- full_df %>% filter(pvalue < 5.243344e-07)
