...
write_tsv(pheno_Ac, wd %&% "rat_pheno_Ac.txt", col_names = FALSE)
write_tsv(pheno_Il, wd %&% "rat_pheno_Il.txt", col_names = FALSE)
write_tsv(pheno_Lh, wd %&% "rat_pheno_Lh.txt", col_names = FALSE)
write_tsv(pheno_Pl, wd %&% "rat_pheno_Pl.txt", col_names = FALSE)
write_tsv(pheno_Vo, wd %&% "rat_pheno_Vo.txt", col_names = FALSE)
```
...
plink --file rat_genotype --make-bed --out rat_genome_Ac

mv rat_genotype.map rat_genotype_Il.map
plink --file rat_genotype_Il --make-bed --out rat_genome_Il

mv rat_genotype_Il.map rat_genotype_Lh.map
plink --file rat_genotype_Lh --make-bed --out rat_genome_Lh

mv rat_genotype_Lh.map rat_genotype_Pl.map
plink --file rat_genotype_Pl --make-bed --out rat_genome_Pl

mv rat_genotype_Pl.map rat_genotype_Vo.map
plink --file rat_genotype_Vo --make-bed --out rat_genome_Vo
```
