...
plt_1 <- (ggplot(data = A_df_Ac, aes(x = index))
          ...
          + labs(x = 'Genes Sorted by Proportion of Variance Explained (PVE)',
                 y = 'PVE')
           + annotate("text", x = 1250, y = 0.9, label = "Mean h2 =  0.089", size = 6)
...
plt_2  <- (ggplot(data = hum_df, aes(x = index))
          ...
          + labs(x = 'Genes Sorted by Proportion of Variance Explained (PVE)',
                 y = 'PVE')
          + ylim(c(0,1))
           + annotate("text", x = 1590, y = 0.9, label = "Mean h2 =  0.129", size = 6)
           + annotate("text", x = 1550, y = 0.8, label = "Mean r2 =  0.119", size = 6)) 
plt_2
```
