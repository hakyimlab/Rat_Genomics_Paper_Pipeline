...
geno_Ac = geno[,match(colnames(gexAc), colnames(geno))]
geno_Il = geno[,match(colnames(gexIl), colnames(geno))]
geno_Lh = geno[,match(colnames(gexLh), colnames(geno))]
geno_Pl = geno[,match(colnames(gexPl), colnames(geno))]
geno_Vo = geno[,match(colnames(gexVo), colnames(geno))]
```
